...
//    /* --------------------------------------------  configuration  --------------------------------------------- */
//    private static final String semanticFolderName = "Compiler-Design-Implementation/testcases/sema";
//    private static final String codeGenFolderPathPrefix = "Compiler-Design-Implementation/testcases/codegen/";
//    private static final String tmpFolderName = ".tmp";
//    private static final String tmpFilePath = tmpFolderName + "/test";
//    private static final String builtinPath = "builtin.ll";
...
//            //System.err.println("wsl" + clang + builtinPath + llFileName + "-o" + exeFileName + "-m32");
